...
class albumInfo():
    def __init__(self):
        ...
        self.album_artwork = Entry(tab1, bd=5, width=50)
        ...
        self.album_artwork.grid(row=5, column=1, sticky=W)
        self.genre.grid(row=6, column=1, sticky=W)
        ...
        Label(tab1, text='Album Artwork', padx=10).grid(row=5, column=0, sticky=E)
        Label(tab1, text='Genre', padx=10).grid(row=6, column=0, sticky=E)
        Label(tab1, text='Year', padx=10).grid(row=7, column=0, sticky=E)
    ...
    def setter(self):
        ...
        self.album_artwork = self.album_artwork.get()
    ...
    def downloader(self):
        ...
        r = requests.get(self.album_artwork)
        with open(self.folder_name + "/album_artwork.jpg", "wb") as f:
            f.write(r.content)
    ...
    def metadataTagger(self, song_name, track_num):
        ...
        song.tag.images.set(ImageFrame.FRONT_COVER,open(self.folder_name + '/album_artwork.jpg','rb').read(), 'image/jpg')
